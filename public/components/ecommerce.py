...
main_content = Div("w-3/5 p-6", [
    ...
    Div("grid grid-cols-1 gap-6 h-3/4 overflow-y-auto", [
      CoffeeCard(
        ...
        Header2("Ethiopia Yirgacheffe", text + " text-2xl font-bold"), 
        [
            Badge("Citrusy", {}), 
            Badge("Balanced", {}),
            Badge("Nutty", {}), 
        ...
        Span(text+ " font-bold", "$20 per 1KG"),
      ...
      CoffeeCard(
        ...
        Header2("Colombia Supremo", text + " text-2xl font-bold"), 
        [
            Badge("Arabica", {}), 
            Badge("washed", {}), 
            Badge("Floral", {}), 
        ], 
        Span(text+ " font-bold", "$22 per 1KG"),
      ...
      CoffeeCard(
        ...
        Header2("Guatemala Antigua", text + " text-2xl font-bold"), 
        [
            Badge("Balanced", {}), 
            Badge("Nutty", {}), 
        ], 
      ...
      CoffeeCard(
        ...
        Header2("Kenya AA", text + " text-2xl font-bold"), 
        [
            Badge("Chocolatey", {}), 
            Badge("Fruity", {}), 
            Badge("Complex", {}), 
        ], 
        Span(text+ " font-bold", "$60 per 1KG"),
        Span(text, "Shipping: 1-2 days"),
      ...
      CoffeeCard(
        ...
        Header2("Costa Rica Tarrazu", text + " text-2xl font-bold"), 
        [
            Badge("Citrusy", {}), 
            Badge("Complex", {}), 
        ], 
        Span(text+ " font-bold", "$35 per 1KG"),
      ...
      CoffeeCard(
        ...
        Header2("Panama Geisha", text + " text-2xl font-bold"), 
        [
            Badge("Arabica", {}), 
            Badge("washed", {}),
            Badge("Complex", {}), 
        ], 
        Span(text+ " font-bold", "$55 per 1KG"),
