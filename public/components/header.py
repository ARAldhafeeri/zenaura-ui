...
class Header(Component):
	def __init__(self, class_names_nav="bg-gray-800", class_names_container="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8", class_names_div="relative flex h-16 items-center justify-between"):
