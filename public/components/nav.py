...
def NavItemText(href, text, class_names=""):
        return Builder('a').with_attribute('href', href).with_attribute("class", class_names).with_text(text).build()
			...
			[
				...
				Div("relative ml-3", [
						Div("", [
								ButtonWithAttrsChildren(
										"""
											relative flex rounded-full bg-gray-800 text-sm focus:outline-none 
